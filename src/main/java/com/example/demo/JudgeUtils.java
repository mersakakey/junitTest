...
public class JudgeUtils extends MiraiPrjApplication {
	...
	// 定数
	public static final int CAN_PLAY_AGE = 17;
	public static final int CAN_PAY_AGE = 18;
	/**
	 * 課金対象か判定するメソッド<br>
	 *
	 * @param birthDay 生年月日
	...
	public boolean isBillingAge(Date birthDay) {
		...
		// 年からプレイ可能年齢を引く
		compareCal.add(Calendar.YEAR, -CAN_PAY_AGE);
	...
	public boolean isRegisterdAge(Date birthDay) {
		...
		compareCal.set(curYear, curMonth, curDate);
		// 年からプレイ可能年齢を引く
		compareCal.add(Calendar.YEAR, -CAN_PLAY_AGE);
